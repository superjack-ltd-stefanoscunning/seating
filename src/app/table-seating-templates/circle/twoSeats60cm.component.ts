...
@Component({
  standalone: true,
  selector: 'app-2seat60',
  templateUrl: './twoSeats60cm.component.svg',
  styleUrls: ['./twoSeats60cm.component.scss'],
})
export class TwoSeats60cmComponent implements OnInit, OnChanges {
  @Input() table!: Table;
